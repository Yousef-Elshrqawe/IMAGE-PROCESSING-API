...
import processImage from './ts-image-processing';
...
export default class File {
    static imagesFullPath = path.resolve(__dirname, '../assets/images/FullPath');
    static imagesThumbPath = path.resolve(__dirname, '../assets/images/ThumbPath');
